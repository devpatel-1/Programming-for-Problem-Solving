// Demonstrate the use of following operators by a separate program foreach:
// a) Arithmetic Operators: +, -, *, /, %, ++, --
// b) Relational Operators: ==, !=, <, >, <=, >=
// c) Logical operators: &&, ||, !
// d) Conditional operator: <expr1>?<expr2>:<expr3>
// e) Shorthand assignment: +=, -=, *=, /=, %/
// f) Bitwise operator: &, |, ^, <<, >> ,~
// g) Increment-Decrement operator:
// h) Print following table as output using sizeof() operator:
